...
static const char *DEFAULT_CONFIG =
    ...
    "load_plugins=1\n"
    "; 1 = CPU core/affinity fix: on Intel 12th-gen+ hybrid CPUs the\n"
    "; P-cores are auto-detected (CPUID leaf 0x1A) and the game is kept\n"
    "; on the lowest cpu_cores P-core threads. Fixes the loading hang.\n"
    "cpu_core_fix=0\n"
    "; Logical-processor count the game sees / is limited to (0..256).\n"
    "; 0 = keep every detected P-core (no trim); 1..256 = keep the lowest\n"
    "; cpu_cores P-core threads. When no hybrid is detected the low\n"
    "; cpu_cores logical CPUs are kept (0 or missing treated as 8).\n"
    "cpu_cores=8\n"
    "\n"
    "[plugins]\n"
