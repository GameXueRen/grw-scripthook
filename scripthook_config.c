...
static const char *DEFAULT_CONFIG =
    ...
    "; The game renames N.save to N.save.delete and writes a .delete\n"
    "; beside it; that file is the record the save list reads as gone.\n"
    "; Both are held out of the save folder and the save is put back\n"
    "; from a clean copy, so no trace of the wipe is left on disk and\n"
    "; the slot is listed again on the next launch. Deleting a slot by\n"
    "; hand is caught too - turn the plugin off to remove one.\n"
    "; Single player only, and delete the plugin folder once patched.\n"
